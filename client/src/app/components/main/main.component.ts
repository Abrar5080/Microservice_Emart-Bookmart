...
export class MainComponent implements OnInit {
  ...
  openForm() {
    if (this.user) {
      // Proceed with buying or adding to cart
      console.log("User is logged in, proceed with Add to Cart / Buy Now");
      // You can add your logic here to handle the actual cart logic
      this.modalHeader = "Success!";
      this.modalBody = "Product has been added to cart or purchased.";
      this.openModal();
    } else {
      // Show login modal
